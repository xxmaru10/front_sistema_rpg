...
| Avatar Compacto no Voice Chat (Story 28) | Grid `flex-wrap` no painel de voz: foto via `<img objectFit: cover>` (fix de bug CSS background shorthand) + nome curto abaixo do círculo. Controles (mute + slider 0–200 + número) em linha horizontal. Mesmo padrão aplicado nos indicadores flutuantes laterais. | 2026-04-06 |
